...
if __name__ == '__main__':
	...
	##création du fichier CSV pour les résultats
	...
	for elemn in list_eleves:
		...
		depart = xform.transform(QgsPoint(float(elem[4]),float(elem[5])))
    #print"list_eleves,elemn"#transformation des coordo de départ = adresses eleves en point qgis
